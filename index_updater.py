...
from .index_updater_dockwidget import IndexUpdaterDockWidget
import os.path
...
class IndexUpdater:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'IndexUpdater_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Index Updater')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'IndexUpdater')
        self.toolbar.setObjectName(u'IndexUpdater')

        #print "** INITIALIZING IndexUpdater"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('IndexUpdater', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/index_updater/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Index Updater'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD IndexUpdater"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Index Updater'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = IndexUpdaterDockWidget()
